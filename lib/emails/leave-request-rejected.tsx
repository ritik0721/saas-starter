...
export default function LeaveRequestRejectedEmail({
  userName,
  leaveType,
  startDate,
  endDate,
  ...
  return (
    <Html>
      <Head />
      <Preview>Leave Request Update - {companyName}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>Leave Request Update</Heading>
          ...
          <Section style={section}>
            ...
            <Text style={text}>
              Your leave request has been reviewed by <strong>{rejectedBy}</strong> and unfortunately could not be approved at this time.
            </Text>
          </Section>
            ...
            {reason && (
              <Row style={row}>
                <Column style={fullColumn}>
                  <Text style={label}>Your Reason:</Text>
          ...
          <Section style={rejectionSection}>
            <Heading style={h2}>Rejection Reason</Heading>
          ...
          <Section style={section}>
            <Text style={text}>
              If you have any questions about this decision, please reach out to {rejectedBy} directly. You can also submit a new leave request with different dates or details.
            </Text>
          </Section>
